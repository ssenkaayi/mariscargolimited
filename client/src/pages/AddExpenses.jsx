...
export default function AddExpenses() {
    ...
    const handleSubmit = async(e)=>{
      ...
      try{
        ...
        const res = await fetch('/api/expense/',{
          ...
          body:JSON.stringify({...formData,tripRef:supplier_id})
  ...
  return (
       ...
       <div className='w-full h-full bg-slate-200 grid place-items-center'>
        ...
        <h3 className='mt-4  text-5xl'>REGISTER NEW EXPENSE</h3>
            ...
            <form className='flex flex-col w-[500px] P-4' onSubmit={handleSubmit}  >
              ...
              <div className='flex flex-col gap-4'>
                  ...
                  <label className='mb-4 text-1xl font-semibold'>Tax</label>
                  <input type="Number" placeholder="Tax" id='tax' className='border p-3 rounded-lg'
                  required onChange={handleChange}
                  />
